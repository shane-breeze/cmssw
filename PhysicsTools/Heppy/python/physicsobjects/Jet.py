...
class Jet(PhysicsObject):   
	...
	# elf = self.chargedEmEnergyFraction();
        ...
        if name == "POG_PFID_Loose":    return ((eta<2.7 and ((npr>1 and phf<0.99 and nhf<0.99) and (eta>2.4 or (elf<0.99 and chf>0 and chm>0)))) or (eta>2.7 and eta<=3.0 and phf<0.9 and npn>2) or (eta>3.0 and (phf<0.90 and npn>10)));
        if name == "POG_PFID_Medium":   return (npr>1 and phf<0.95 and nhf<0.95 and muf < 0.8) and (eta>2.4 or (elf<0.99 and chf>0 and chm>0));
        if name == "POG_PFID_Tight":    return ((eta<3.0 and ((npr>1 and phf<0.90 and nhf<0.90) and (eta>2.4 or (elf<0.99 and chf>0 and chm>0)))) or (eta>2.7 and eta<=3.0 and phf<0.9 and npn>2)or (eta>3.0 and (phf<0.90 and npn>10)));
